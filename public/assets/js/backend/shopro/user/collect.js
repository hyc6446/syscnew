    ...
    var Controller = {
            ...
            var collectIndex = new Vue({
                ...
                methods: {
                    ...
                    operation(type, id) {
                        ...
                        switch (type) {
                            case 'edit':
                                Fast.api.open('shopro/user/collect/edit?id=' + id, '查看', {
                                    callback(data) {
                                        if (data.data) {
                                            that.getData();
                                        }
                                ...
                                break;
                            case 'recyclebin':
                                Fast.api.open('shopro/user/collect/recyclebin', '查看回收站')
                                break;
                            case 'del':
                                that.$confirm('此操作将删除申请, 是否继续?', '提示', {
                                    ...
                                    Fast.api.ajax({
                                        url: 'shopro/user/collect/del/ids/' + id,
                                        loading: true,
                                        type: 'POST',
                                    }, function (ret, res) {
                                        that.getData();
        ...
        recyclebin: function () {
            ...
            table.bootstrapTable({
                url: 'shopro/user/collect/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [{
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                url: 'shopro/user/collect/restore',
                                refresh: true
                            },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'shopro/user/collect/destroy',
                                    refresh: true
                                }
                            ],
            ...
            var collectDetail = new Vue({
                ...
                methods: {
                    ...
                    submitFrom(type) {
                        ...
                        if (type == 'yes') {
                            Fast.api.ajax({
                                url: 'shopro/user/collect/edit?id=' + that.detailForm.id,
                                loading: true,
                                type: 'POST',
                                data: {
                                    data: JSON.stringify({
