    ...
    var Controller = {
            ...
            var settledIndex = new Vue({
                ...
                methods: {
                    ...
                    operation(type, id) {
                        ...
                        switch (type) {
                            case 'edit':
                                Fast.api.open('shopro/user/settled/edit?id=' + id, '查看', {
                                    callback(data) {
                                        if (data.data) {
                                            that.getData();
                                        }
                                ...
                                break;
                            case 'recyclebin':
                                Fast.api.open('shopro/user/settled/recyclebin', '查看回收站')
                                break;
                            case 'del':
                                that.$confirm('此操作将删除申请, 是否继续?', '提示', {
                                    confirmButtonText: '确定',
                                    cancelButtonText: '取消',
                                    type: 'warning'
                                }).then(() => {
                                    Fast.api.ajax({
                                        url: 'shopro/user/settled/del/ids/' + id,
                                        loading: true,
                                        type: 'POST',
                                    }, function (ret, res) {
                                        that.getData();
        ...
        recyclebin: function () {
            ...
            table.bootstrapTable({
                url: 'shopro/user/settled/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [{
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                url: 'shopro/user/settled/restore',
                                refresh: true
                            },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'shopro/user/settled/destroy',
                                    refresh: true
                                }
                            ],
            ...
            var settledDetail = new Vue({
                ...
                methods: {
                    ...
                    submitFrom(type) {
                        ...
                        if (type == 'yes') {
                            Fast.api.ajax({
                                url: 'shopro/user/settled/edit?id=' + that.detailForm.id,
                                loading: true,
                                type: 'POST',
                                data: {
                                    data: JSON.stringify({
